...
//    _pageControl.currentPageIndicatorTintColor = [UIColor  applicationMainColor];
//    _pageControl.currentPageIndicatorTintColor = [UIColor  applicationSecondColor];
//    _pageControl.currentPageIndicatorTintColor = [UIColor  redColor];
    _pageControl.currentPageIndicatorTintColor = [UIColor  colorWithRed:228/255.0 green:1/255.0 blue:128/255.0 alpha:1];
